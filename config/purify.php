    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title|id|target],ul,ol,li,p[style|class],br,span[style|class],img[width|height|alt|src],blockquote,sub,sup,figure[class|style],table[class|style],thead,tbody,tfoot,tr,td[style],th,col[style],colgroup,hr',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,margin-left,color,background-color,text-align,width,height,float,list-style-type',
